...
class Dataset_M4(Dataset):
    ...
    def __read_data__(self):
        ...
        training_values = np.array([v[~np.isnan(v)] for v in dataset.values])  # split different frequencies
...
class SWATSegLoader(Dataset):
    def __init__(self, root_path, win_size, step=1, flag="train"):
        ...
        train_data = np.load(os.path.join(root_path, 'swat_train2.npy'))
        test_data = np.load(os.path.join(root_path, 'swat2.npy'))
